...
export const associacoes = sqliteTable("associacoes", {
  ...
  presidenteCpf: text("presidente_cpf"),
  presidenteCep: text("presidente_cep"),
  presidenteEndereco: text("presidente_endereco"),
  presidenteBairro: text("presidente_bairro"),
  presidenteNumero: text("presidente_numero"),
  presidenteMunicipio: text("presidente_municipio"),
  presidenteUf: text("presidente_uf"),
  presidenteEmail: text("presidente_email"),
  documentosJson: text("documentos_json").notNull().default("[]"),
